function ZoomControls({ onZoomIn, onZoomOut }) {
  return (
    <div
      className="flex shrink-0 flex-col gap-1.5 rounded-lg border border-white/10 bg-gray-900/90 px-2 py-1.5 shadow-lg backdrop-blur-sm justify-center items-center"
